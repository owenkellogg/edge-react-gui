...
import edgeMark from '../../assets/images/coinhubLogo/Coin_logo_Icon.png'
import edgeLogo from '../../assets/images/coinhubLogo/Coin_logo_L.png'
...
export const coinhubDark: Theme = {
  ...
  // Background
  backgroundGradientColors: [palette.darkgreyBlue, palette.darkgreyBlue],
