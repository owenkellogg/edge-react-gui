        ...
        <View style={styles.sceneContainer}>
          ...
          <TappableCard nonTappable>
            {srcTokenId == null || srcWalletId == null ? (
              ...
              <>
                <View style={styles.halfContainer}>
                  <CurrencyIcon sizeRem={2} marginRem={[0, 0.5, 0, 0]} tokenId={srcTokenId} walletId={srcWalletId} />
                ...
                <View style={styles.halfContainer}>
                  <CurrencyIcon sizeRem={2} marginRem={[0, 0.5, 0, 0.5]} pluginId="fiat" walletId={srcWalletId} />
